...
Combining the selection models with cluster bootstrapping, particularly two-stage cluster bootstrapping, leads to confidence intervals with close-to-nominal coverage rates.
