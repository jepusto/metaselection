...
step_results_boot <- selection_model(
  data = lehmann_dat, 
  yi = yi,
  sei = sei,
  cluster = Short_Title,
...
The overall estimate of the average effect is `r round(step_results_boot$est$Est[step_results_boot$est$param=="beta"], 3)`, 95% CI [`r round(step_results_boot$est$percentile_lower[step_results_boot$est$param=="beta"], 3)`, `r round(step_results_boot$est$percentile_upper[step_results_boot$est$param=="beta"], 3)`].
