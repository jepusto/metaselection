...
Selective reporting is a major concern for research syntheses because it distorts the evidence base available for a meta-analysis, biasing meta-analytic averages toward more favorable findings and misrepresenting the true population of effects.
...
@pustejovsky2025estimation and @citkowicz2026estimating developed methods for investigating and accounting for selective reporting in meta-analytic models that also account for dependent effect sizes.
...
## Parallel computing and progress
