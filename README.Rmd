...
The package is designed to work with the `progressr` package [@progressr].
...
The package is also designed to work with the `future` package for parallel computing [@future].
