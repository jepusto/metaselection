...
Several existing packages provide tools for estimating selection models assuming that effects are independent.
...
In addition, the `PublicationBias` package [@PublicationBias] implements sensitivity analyses for selective reporting bias that incorporate robust variance estimation methods for handling dependent effect sizes.
