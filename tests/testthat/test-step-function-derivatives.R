...
test_that("step_loglik() divides up the parameter vector appropriately.", {
  ...
  expect_equal(
    step_loglik(theta = theta_A, yi = yi, sei = sei, steps = .07),
    step_loglik(yi = yi, sei = sei, steps = .07, 
  ...
  expect_equal(
    step_loglik(theta = theta_B, yi = yi, sei = sei, steps = .07,
                X = X, U = U, Z = Z),
    step_loglik(yi = yi, sei = sei, steps = .07, 
                X = X, U = U, Z = Z,
  ...
  expect_equal(
    step_loglik(theta = theta_C, yi = yi, sei = sei, steps = c(.02,0.08),
                X = X, U = U, Z0 = Z0, Z = list(Z, Z)),
    step_loglik(yi = yi, sei = sei, steps = c(.02,0.08), 
                X = X, U = U, Z0 = Z0, Z = list(Z, Z),
  ...
  expect_equal(
    step_loglik(theta = theta_D, yi = yi, sei = sei, steps = .07, Z0 = Z0),
    step_loglik(yi = yi, sei = sei, steps = .07, Z0 = Z0, 
                beta = theta_D[1], gamma = theta_D[2], zeta0 = theta_D[3:4], zeta = theta_D[5])
  )
  
})

test_that("step_score() divides up the parameter vector appropriately.", {
  
  # intercept-only, 3PSM
  theta_A <- c(0.2, log(0.05), log(0.36))
  A1 <- step_score(theta = theta_A, yi = yi, sei = sei, steps = .07)
  A2 <- step_score(yi = yi, sei = sei, steps = .07, 
                   beta = theta_A[1], gamma = theta_A[2], zeta = theta_A[3])
  expect_equal(A1, A2)
  ...
  # intercept-only, 4PSM
  theta_E <- c(0.2, log(0.05), log(0.36), log(0.54))
  E1 <- step_score(theta = theta_E, yi = yi, sei = sei, steps = c(.07,.50))
  E2 <- step_score(yi = yi, sei = sei, steps = c(.07,.50), 
                   beta = theta_E[1], gamma = theta_E[2], zeta = theta_E[3:4])
  expect_equal(E1, E2)
  ...
  B1 <- step_score(theta = theta_B, yi = yi, sei = sei, steps = .07,
                   X = X, U = U, Z = Z)
  B2 <- step_score(yi = yi, sei = sei, steps = .07, 
                   X = X, U = U, Z = Z,
                   beta = theta_B[1:2], gamma = theta_B[3:6], zeta = theta_B[7:8])
  expect_equal(B1, B2)
  ...
  theta_C <- c(0.2, 0.04, log(seq(0.02, 0.08, length.out = 4)), 
               log(seq(0.2, 0.5, length.out = 6)))
  C1 <- step_score(theta = theta_C, yi = yi, sei = sei, steps = c(.02,0.08,0.20),
                   X = X, U = U, Z = list(Z, Z, Z))
  C2 <- step_score(yi = yi, sei = sei, steps = c(.02,0.08,0.20), 
                   X = X, U = U, Z = list(Z, Z, Z),
                   beta = theta_C[1:2], gamma = theta_C[3:6], zeta = theta_C[7:12])
  expect_equal(C1, C2)
  ...
  C3 <- step_score(theta = theta_C, yi = yi, sei = sei, steps = c(.02,0.08),
                   X = X, U = U, Z0 = Z0, Z = list(Z, Z))
  C4 <- step_score(yi = yi, sei = sei, steps = c(.02,0.08), 
                   X = X, U = U, Z0 = Z0, Z = list(Z, Z),
  ...
  theta_D <- c(0.2, log(0.05), log(0.36), log(1.2), 0)
  D1 <- step_score(theta = theta_D, yi = yi, sei = sei, steps = .07, Z0 = Z0)
  D2 <- step_score(yi = yi, sei = sei, steps = .07, Z0 = Z0, 
...
test_that("step_hessian() divides up the parameter vector appropriately.", {
  
  theta_A <- c(0.2, log(0.05), log(0.36))
  A1 <- step_hessian(theta = theta_A, yi = yi, sei = sei, steps = .07)
  A2 <- step_hessian(yi = yi, sei = sei, steps = .07, 
                     beta = theta_A[1], gamma = theta_A[2], zeta = theta_A[3])
  A3 <- step_hessian(theta = theta_A, yi = yi, sei = sei, steps = .07, X = intcpt, U = intcpt)
  A4 <- step_hessian(theta = theta_A, yi = yi, sei = sei, steps = .07, Z = intcpt)
  A5 <- step_hessian(theta = theta_A, yi = yi, sei = sei, steps = .07, Z = list(intcpt))
  ...
  # intercept-only, 4PSM
  theta_E <- c(0.2, log(0.05), log(0.36), log(0.54))
  E1 <- step_hessian(theta = theta_E, yi = yi, sei = sei, steps = c(.07,.50))
  E2 <- step_hessian(yi = yi, sei = sei, steps = c(.07,.50), 
                     beta = theta_E[1], gamma = theta_E[2], zeta = theta_E[3:4])
  E3 <- step_hessian(theta = theta_E, yi = yi, sei = sei, steps = c(.07,.50), X = intcpt)
  E4 <- step_hessian(theta = theta_E, yi = yi, sei = sei, steps = c(.07,.50), Z = list(intcpt, intcpt))
  ...
  # with predictors, one step
  theta_B <- c(0.2, 0.04, log(seq(0.02, 0.08, length.out = 4)), log(0.36), log(0.54))
  B1 <- step_hessian(theta = theta_B, yi = yi, sei = sei, steps = .07,
                     X = X, U = U, Z = Z)
  B2 <- step_hessian(yi = yi, sei = sei, steps = .07, 
                     X = X, U = U, Z = Z,
                     beta = theta_B[1:2], gamma = theta_B[3:6], zeta = theta_B[7:8])
  ...
  theta_C <- c(0.2, 0.04, log(seq(0.02, 0.08, length.out = 4)), 
               log(seq(0.2, 0.5, length.out = 6)))
  C1 <- step_hessian(theta = theta_C, yi = yi, sei = sei, steps = c(.02,0.08,0.20),
                    X = X, U = U, Z = list(Z, Z, Z))
  C2 <- step_hessian(yi = yi, sei = sei, steps = c(.02,0.08,0.20), 
                     X = X, U = U, Z = list(Z, Z, Z),
                     beta = theta_C[1:2], gamma = theta_C[3:6], zeta = theta_C[7:12])
  expect_equal(C1, C2)
  ...
  # with predictors for lambda0
  F1 <- step_hessian(theta = theta_C, yi = yi, sei = sei, steps = c(.02,0.08),
                     X = X, U = U, Z0 = Z0, Z = list(Z, Z))
  F2 <- step_hessian(yi = yi, sei = sei, steps = c(.02,0.08), 
                     X = X, U = U, Z0 = Z0, Z = list(Z, Z),
                     beta = theta_C[1:2], gamma = theta_C[3:6], 
                     zeta0 = theta_C[7:8], zeta = theta_C[9:12])
  ...
  theta_D <- c(0.2, log(0.05), log(0.36), log(1.2), 0)
  D1 <- step_hessian(theta = theta_D, yi = yi, sei = sei, steps = .07, Z0 = Z0)
  D2 <- step_hessian(yi = yi, sei = sei, steps = .07, Z0 = Z0, 
                     beta = theta_D[1], gamma = theta_D[2], 
                     zeta0 = theta_D[3:4], zeta = theta_D[5])
  D3 <- step_hessian(theta = theta_D, yi = yi, sei = sei, steps = .07, Z0 = Z0, Z = intcpt)
...
test_that("step_score() is an unbiased estimating equation for models with covariates.", {
  ...
  check_step_score_hessian_bias(
    ...
    m = 1000, 
    steps = c(.05,.5), 
    weights = list(c(0.90,0.20), c(0.90,0.10)),
    m_multiplier = 5,
    verbose = verbose,
    seed = 20240419
  )
  ...
  check_step_score_hessian_bias(
    mean_smd = c(0.05, 0.05), 
    tau = 0.1, 
    m = 1000, 
    steps = c(.05,.5), 
    weights = list(c(0.30,0.80), c(0.10,0.30)),
    m_multiplier = 5,
    verbose = verbose,
    seed = 20240421
  )
  ...
  check_step_score_hessian_bias(
    ...
    m = 1000, 
    steps = c(.05,.5), 
    weights = list(c(0.10,0.80), c(0.20,0.70)),
    mean_N = 120,
    m_multiplier = 5,
    verbose = verbose,
    seed = 20230417
  ...
  check_step_score_hessian_bias(
    mean_smd = c(0.5, -0.1, 0.1), 
    tau = 0.1, 
    m = 800, 
    steps = c(.025, .500), 
    weights = list(c(1.00,0.80), c(0.70,0.05), c(0.80,0.30)),
    mean_N = 180,
    m_multiplier = 5,
    verbose = verbose,
    seed = 20240412,
  ...
  check_step_score_hessian_bias(
    mean_smd = c(0.1, 0.0, -0.3),
    tau = 0.01, 
    m = 1000, 
    steps = .25, 
    weights = list(0.50, 0.02, 0.10),
    m_multiplier = 5,
    mean_N = 150,
    verbose = verbose,
    seed = 20240419,
  ...
  check_step_score_hessian_bias(
    mean_smd = c(0.24, 0.56), 
    tau = 0.4, 
    m = 1000, 
    steps = .05, 
    weights = list(0.50, 0.30),
    m_multiplier = 5,
    mean_N = 180,
    verbose = verbose,
    seed = 20240413
