...
The overall estimate of the average effect is `r round(che_res$beta, 3)`, which is significantly different from zero (p = `r round(che_res$p, 3)`). Next, we examine how this estimate differs from the estimates calculated using the `metaselection` package.
