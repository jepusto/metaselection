...
By default, the function fits the model using maximum penalized composite marginal likelihood estimation and calculates standard errors and confidence intervals using CRVE.[^2]

[^2]: One can interpret these results as a preliminary analysis.
    For a more refined and reliable analysis, one should use two-statge clustered bootstrap confidence intervals instead of CRVE.
...
However, as can be seen from the robust confidence intervals in the model output, the selection parameters are very imprecisely estimated.[^3]

[^3]: Again, this preliminary analysis should be refined by using clustered bootstrap confidence intervals instead of CRVE.
