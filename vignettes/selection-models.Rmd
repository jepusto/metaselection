...
In the general formulation, suppose that there are $H$ steps, $\alpha_1,...,\alpha_H$, and that
...
The modification involves truncating the selection probabilities at user-specified steps $\alpha_1$ and $\alpha_2$, so that the selection function is given by
