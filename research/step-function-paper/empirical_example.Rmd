...
Based on a sample of 66 studies, @carter2015series estimated an overall average effect of 0.43, with a 95% CI of [0.34, 0.52]. However, more recent, pre-registered replication studies present a stark contrast, finding average effects near zero based on samples collected across dozens of laboratories.[@Hagger2016ego; @Vohs2021ego]. This discrepancy highlights the importance of investigating selective reporting bias in meta-analytic datasets.
...
The PET-PEESE estimate is negative and much smaller than the CHE and CHE-ISCW estimates, indicating a pattern of small study effects. 
...
Generally, the PML and ARGL parameter estimates are similar in magnitude, but the confidence intervals based on the CML estimator are narrower than those for the ARGL estimator.
