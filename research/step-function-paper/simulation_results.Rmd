...
Figures \@ref(fig:rmse-ARGL-CML) through \@ref(fig:rmse-PET-ARGL) in `r appendix_prefix` \@ref(mu-simulation-results) provide greater detail about the relative accuracy of the four methods by plotting the ratio of scaled RMSEs for each pair of methods. In addition, Figure \@ref(fig:mu-rmse-nonscaled) depicts the non-scaled version of the RMSE of each estimator of average effect size.
