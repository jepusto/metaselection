...
Its largest bias, of `r round(CML_bias$max_abs_bias,2)` occurs when selective reporting is very strong, average effect size is zero, and heterogeneity is large.
