...
# Score and Hessian of the step-function marginal log likelihood {#PML-derivatives}
...
\end{equation}
The score for the selection parameters has the general form $\mat{S}_{\bs\zeta j} = \left(S_{\zeta_1 j},...,S_{\zeta_H j} \right)'$, where
\begin{equation}
