...
Specifically, we used the CHE working model with inverse sampling-covariance weights (CHE-ISCW) as proposed by @chen2024adapting. 
...
Second, we implemented a variation of the PET/PEESE estimator originally proposed by @stanley2014meta, adapted to
...
CR2 cluster-robust standard errors. Following @stanley2014meta, we combined
