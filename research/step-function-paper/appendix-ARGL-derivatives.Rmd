...
\end{align}
The third component is the score equation for $\bs\zeta$ based on the marginal likelihood. Its exact form is given in Equation \@ref(eq:zeta-score-component).
