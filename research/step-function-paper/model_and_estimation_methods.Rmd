...
\begin{equation}
\label{eq:zeta-prior}
p_{\bs\zeta}(\bs\zeta) = \frac{-1}{16} \sum_{q=1}^z \left(\zeta_q - \log\left(\frac{1}{5}\right)\right)^4
\end{equation}
...
lambda_bench <- c(0.02, 0.05, 0.10, 0.20, 0.50, 1, 2, 4)
