...
Additional results concerning the bias and RMSE for the marginal variance of the effect size distribution, as well as the performance of the the selection parameters for the selection models, are provided in Appendix X.
...
\section{Sensitivity to Selective Reporting: Beta-Density vs.~Standard Approaches}\label{sensitivity-to-selective-reporting-beta-density-vs.-standard-approaches-1}
...
\section{Robustness to Selection Function Misspecification: Beta-Density vs.~Step Models}\label{robustness-to-selection-function-misspecification-beta-density-vs.-step-models-1}
