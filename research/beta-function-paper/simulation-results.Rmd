...
<!-- JEP: It does? The general impression I get from Figure 4 is that all the methods have garbage coverage, even with a large number of studies. -->
<!-- MC: Good point. I revised the coverage results. -->
...
<!-- JEP: Out of how many conditions in all? -->
<!-- MC: Added. -->
...
<!-- JEP: Do we need these results at all? Should we show the percentile bootstrap CI results for all three models in addition to the large-sample results? -->
<!-- MC: Good point. We already established the large sample CIs are not great. I updated the graph and results to just focus on the two-stage percentile CI results, citing that the other results are in the supplemental materials.
However, just as in the other bootstrap figure, I can't get all the values to show up, even if I unrestrict the y-axis. Ideas?-->
