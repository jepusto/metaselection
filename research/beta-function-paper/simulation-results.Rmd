...
All three approaches---beta-density selection model, CHE-ISCW, and PET/PEESE---had perfect convergence rates, producing results for every replication across all $`r formatC(4 * 4 * 2 * 2 * 5 * 4, big.mark = ",")`$ conditions. <!-- MC: Dropped figure as it's no longer interesting with 100% convergence. -->
